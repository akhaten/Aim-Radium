...
int main(int argc, char** argv)
{
	...
	// Inspiré de ExempleApps/CustomCameraManipulator/main.cpp
	Ra::Gui::BaseApplication application(argc, argv);
	application.initialize(Ra::Gui::SimpleWindowFactory{});
	//application.m_mainWindow->prepareDisplay();

	//auto viewer = application.m_mainWindow->getViewer();
	//viewer->setCameraManipulator(new CameraManipulatorFPS(*(viewer->getCameraManipulator())));
	//viewer->setCameraManipulator(new CameraManipulatorFPS());
